 ...
 * \sa  setTopWidgetVisible, topWidgetVisible
 */
...
/*!
 *
 * \brief returns pointer to a button associated with a child under \a index
 */
...
/*!
 *
 * \brief returns icon of the widget under \a index
 */
...
/*!
 * \brief Returns label of the widget under \a index
 */
