...
TARGET                        =   $$dsLibraryTarget(qwtmathml)
QT                            +=  xml widgets

HEADERS                       =   qwt_mathml_text_engine.h
SOURCES                       =   qwt_mathml_text_engine.cpp
...
CONFIG(lib_bundle) {
  FWKHEADERS.version          =   Versions
  FWKHEADERS.files            =   qwt_mathml_text_engine.h
  FWKHEADERS.path             =   Headers
